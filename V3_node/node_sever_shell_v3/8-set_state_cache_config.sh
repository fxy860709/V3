...
echo ${path}
pwd
sed -i "s/life_window: [0-9]\+/life_window: "300000000000"/g" chainmaker.yml
#sed -i "s/clean_window: [0-9]\+/clean_window: "100000000"/g" chainmaker.yml
#num=$(sed -n '/monitor/=' chainmaker.yml)
#line_num=$(($num+2))
#echo "monitor 配置在第${num}行"
#sed -i "$line_num s/false/true/g" chainmaker.yml

cat chainmaker.yml |grep "life_window"
