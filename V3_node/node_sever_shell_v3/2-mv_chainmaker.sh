...
pwd
ls -al
chainmaker_node_path="${chainmaker_path}/chainmaker-${chainmaker_version}-wx-${org}.chainmaker.org"
...
if [ $number == 0 ];then
	...
	#rm -f ${chainmaker_path}/*.gz
        echo "########## tar x #############"
	#tar zxvf /home/fxy/chainmaker-${chainmaker_version}-wx-${org}*.tar.gz -C /mnt/datadisk0/chainmaker/
        #tar zxvf /home/fxy/chainmaker-${chainmaker_version}-wx-${org}.chainmaker.org-20210917160235-x86_64.tar.gz -C /mnt/datadisk0/chainmaker/
        cd ${chainmaker_path}
        #cp /home/fxy/chainmaker-${chainmaker_version}-wx-${org}*x86_64.tar.gz ./
	pwd
	ls -al
	tar zxvf chainmaker-${chainmaker_version}-wx-${org}*x86_64.tar.gz 
	#ls /home/fxy/chainmaker-${chainmaker_version}-wx-${org}*x86_64.tar.gz | xargs -n1 tar xzvf
        #echo "########## mv ################"
        #mv /mnt/datadisk0/chainmaker/chainmaker-${chainmaker_version}-wx-${org}.chainmaker.org /mnt/datadisk0/chainmaker/chainmaker-wx-${org}.chainmaker.org.consensus
else
        exit
fi
