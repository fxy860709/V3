...
update_sdk_config(){
read -p "请检查如上步骤执行结果，按任意键更新cmc下的证书："
cp -r ${cryptogen_path}/bin/crypto-config/wx-org5.chainmaker.org ${chainmaker_path}/tools/cmc/testdata/crypto-config
}
gen_new_cert
copy_node_file
update_cert
